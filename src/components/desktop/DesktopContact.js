    ...
    <div className="main-sec">
      <div className="intro-container">
        <div className="intro">
          <h3>About: </h3>
          <h5>
            Skin Genie is a project engineered and designed by software
            developer Katy Nichols.
          </h5>
          <p>
          ...
          <p>
            ...
            product, you should be certain to check the ingredients and with
            your dermatologist. No products mentioned are sponsored in any way.
          </p>
          <h3>Contact:</h3>
